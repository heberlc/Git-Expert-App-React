...
export const AddCategory = ({ setCategories }) => {
    ...
    return (
        ...
        <form onSubmit={handleSubmit} className="my-5 sm:flex md:items-center md:content-center">
            ...
            />
            <button className="block border-4 border-gray-800 hover:border-white bg-white hover:bg-gray-800 hover:text-white py-3 px-6 mx-auto rounded-full">Buscar</button>
        </form>
