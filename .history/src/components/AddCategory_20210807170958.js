...
export const AddCategory = ({ setCategories }) => {
    ...
    return (
        ...
        <form onSubmit={handleSubmit} className="my-5 sm:flex md:items-center md:content-center">
            ...
            />
            <button className="block border-4 border-gray-200 text-lg font-bold hover:border-gray-800 bg-white hover:bg-white hover:text-gray-800 transition duration-500  py-3 px-6 mx-auto rounded-full">Buscar</button>
        </form>
